  ...
  return (
    <div>
      ...
      <section className="min-h-screen bg-[#0a0a0a] p-4 relative overflow-hidden">
        <h1 className="uppercase text-white text-[2rem] leading-[0.95] my-3 font-display tracking-[0.02em] font-semibold lg:text-[4.5rem] italic">
          Account settings
        </h1>
        ...
        <section className="my-3">
          ...
          <Input
            ...
            className="text-white rounded-none p-5 uppercase bg-[#131313] border-[#4d5518]"
          />
          ...
          <Input
            ...
            className="text-white rounded-none p-5 bg-[#131313] border-[#4d5518]"
          />
        </section>
